...
let setTime = Number(select.value)

optionsTimer.forEach((options) => {
  if (setTime === options.timerOptions) {
    timer5 = options;
  }
})
...
let timer = timer5.timerOptions === setTime ? setTime : 5;
